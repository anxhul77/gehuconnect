  ...
  return (
    ...
    <Tabs screenOptions={{
      ...
      <Tabs.Screen
        name="home"
        options={{
          title: 'home', tabBarIcon: ({ focused, size }) => (
      ...
      <Tabs.Screen
        name="communities"
        options={{
          title: "Communities", tabBarIcon: ({ focused, size }) => (
      ...
      <Tabs.Screen name="acadmecis"
        options={{
          title: "Acadmecis", tabBarIcon: ({ focused, size }) => (
            <Feather name="book-open" size={size} color={focused ? "#FF6B35" : "#999"} />), header: () => (<AcadmicsHeader />),
        }}></Tabs.Screen>
      ...
      <Tabs.Screen
        name="marketplace"
        options={{
          title: 'Marketplace', tabBarIcon: ({ focused, size }) => (
